...
const HR_NAV_ITEMS = [
  ...
  { href: "/dashboard/hr/branches", label: "Branches", icon: "building" },
  { href: "/dashboard/hr/salaries", label: "Salaries", icon: "wallet" },
  { href: "/dashboard/hr/payroll", label: "Payroll", icon: "banknotes" },
  { href: "/dashboard/hr/attendance", label: "Attendance", icon: "clock" },
  { href: "/dashboard/hr/leave", label: "Leave", icon: "calendar" },
  { href: "/dashboard/hr/reviews", label: "Reviews", icon: "star" },
];
...
export default function DashboardLayout({
  ...
  return (
    <div className="min-h-screen bg-navy-50 flex">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-50 w-64 bg-navy-900 transform transition-transform lg:transform-none ${
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t border-navy-800">
            ...
            <button
              ...
              className="w-full px-4 py-2 text-sm text-navy-300 hover:text-white hover:bg-navy-800 rounded-lg transition-colors text-left"
            >
              Log Out
            </button>
          </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Top bar */}
        <header className="bg-white border-b border-navy-100 px-4 py-3 flex items-center gap-4 lg:px-8">
          <button
