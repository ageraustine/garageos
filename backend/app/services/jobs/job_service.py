...
from app.models.catalog.service import JobService as JobServiceModel, JobStageCompletion
...
from app.models.jobs.line_item import LineItem
...
from app.services.crm.vehicle_service import VehicleService
...
class JobService:
    ...
    def toggle_stage_completion(
        ...
        """
        from app.models.catalog.service import ServiceStage
    ...
    def delete(self, job_id: int) -> None:
        ...
        from app.models.jobs.estimate import Estimate
        from app.models.jobs.media_asset import MediaAsset
